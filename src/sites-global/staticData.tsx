export const StaticData = {
    Meta_title:"MGM Timber Branch Locator - Online Clothes Store",
    Meta_description:"Visit MGM Timber Store | MGM is your local great value family retailer shop. Find latest seasonal looks for Women, Men and kids, plus a huge range of homeware.",
    locator_breadcrumb:"Find Store",

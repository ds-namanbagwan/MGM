    ...
    <tr className={currentDay} >
      {Status ? (
        <td className="dayName" >
          <span className="checked"></span> <span className="span-dayname">{dayName}*</span>
          {/* {c_specific_day &&
                      ...
                      {openint.isClosed ? (
                        ...
                        openint.openIntervals.map((res: any,index:any) => {
                          return (
                              ...
                              <div className="time-group" key={index}>
                                <span className="time-b uppercase">
...
const Hours = (props: Hours) => {
  ...
  let s;
  let dateNewFormat;
  const {hours, additionalHoursText, c_specific_day } = props;
  function join(t: any, a: any, s: any) {
    function format(m: any) {
      const f = new Intl.DateTimeFormat("en", m);
      return f.format(t);
  ...
  if (typeof hours != 'undefined' && typeof hours.reopenDate != 'undefined') {
    a = [{ day: "numeric" }, { month: "long" }, { year: "numeric" }];
    ...
    <>
      <table className="day-hrs">
        ...
        {hours && hours.reopenDate ? (
          ...
          <>{hours && renderHours(hours, c_specific_day)}</>
        )}
      </table>
    </>
  );

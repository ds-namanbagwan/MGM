...
<Link props={footer.c_getQuote} />
              ...
              {footer.c_store_finder.map((storfinder: any) => {
                return (
                  <div className="store-inner" key={storfinder.icon.url}>
                    <img src={storfinder.icon.url} height={storfinder.icon.height} width={storfinder.icon.width} alt="store-finder" />
              ...
              <div className="jd-group">
                <img src={jdgroup} alt="jdgroup" height={36} width={480} />
              </div>
            </div>
              ...
              <div className="footer-block">
                ...
                <ul className="list-none">
                  {footer.c_customerServicesLinks.map(
                    (item: any) => {
                      return (
                        <li key={item.customerServices.label}>
                          <Link props={item.customerServices} />
                        </li>
                      );
                    }
                  )}
            ...
            <div className="store-inner flex flex-raw">
              {footer.c_paySecurelyIcon &&
                footer.c_paySecurelyIcon.map((Icon: any) => {
                  return (
                    <div>
                      <img src={Icon.url} height={Icon.height} width={Icon.width}  alt="faq-icon" />
                    </div>
                  );
                })}
              <div></div>
